  ...
  function k(e, t, c, r) {
    ...
    function l() {
      p += null != b.sL ? function () {
        ...
        var e, t, r, a, n, i, s;
        if (!b.k) return y(m);
        for (a = "", t = 0, b.lR.lastIndex = 0, r = b.lR.exec(m); r;) a += y(m.substring(t, r.index)), n = b, i = r, s = d.cI ? i[0].toLowerCase() : i[0], (e = n.k.hasOwnProperty(s) && n.k[s]) ? (f += e[1], a += o(e[0], y(r[0]))) : a += y(r[0]), t = b.lR.lastIndex, r = b.lR.exec(m);
